...
class GeradorInserts:
    ...
    def __descompactar_arquivo(self, nome_arquivo_zip: str) -> bool:
    ...
    def __carregar_arquivos_csv(self) -> bool:
    ...
    def executar(self):
        ...
        """
        if not self.__descompactar_arquivo("dados.zip"):
            return

        if not self.__carregar_arquivos_csv():
            return
